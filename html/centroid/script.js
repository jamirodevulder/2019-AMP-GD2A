...
let D = new Point(new Vector2d(200,200),20,"black","",true);
let E = new Point(new Vector2d(900,600),20,"black","",true);
let F = new Point(new Vector2d(400,400),20,"black","",true);

let M = new Point(new Vector2d(width/2,height/2),10,"rgba(0,0,0,0.5)","Intersect",false);
